...
import SortingOption from "../Sort/SortingOption"
...
const GalleryHeader = ({
    ...
    return (
        <div className='flex items-center justify-between w-full mb-5 lg:mb-12'>
            <h1 className='font-bold text-lg lg:text-3xl flex items-center'>
                Photography
                <span className='text-3xl mx-1 lg:mx-'>/</span>
                <span className='font-normal text-slate-700 text-lg lg:text-3xl' >Premium Photos</span>
            </h1>
            <SortingOption  
                sortType={sortType} 
            ...
            />
            <button className="lg:hidden" aria-label="open filter options" onClick={() => setOpenFiler(!openFilter)}>
